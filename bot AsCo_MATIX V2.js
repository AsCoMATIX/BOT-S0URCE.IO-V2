...
config = {
	...
	message: "BOT By AsCo_MATIX V2",
	autoTarget: true,
	autoAttack: true,
	// the base64 database url
	db: "https://github.com/AsCoMATIX/BOT-S0URCE.IO-V2/blob/main/bot%20AsCo_MATIX%20V2.js",
...
gui = {
	show: () => {
		...
		$("#custom-github-button").on("click", () => {
			window.open("https://github.com/AsCoMATIX/BOT-S0URCE.IO-V2");
		});
